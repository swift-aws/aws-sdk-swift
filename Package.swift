...
let package = Package(
    ...
    products: [
        ...
        .library(name: "SotoELB", targets: ["SotoELB"]),
        .library(name: "SotoELBV2", targets: ["SotoELBV2"]),
    ...
    targets: [
        ...
        .target(name: "SotoELB", dependencies: [.product(name:"SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/ELB"),
        .target(name: "SotoELBV2", dependencies: [.product(name:"SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/ELBV2"),
