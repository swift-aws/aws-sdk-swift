...
extension Route53 {
    ...
    public struct AliasTarget: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 		        Amazon API Gateway custom regional APIs and edge-optimized APIs  Specify the applicable domain name for your API. You can get the applicable value using the AWS CLI command
        /// 					get-domain-names:
        ...
        ///
        /// 				         ELB load balancer  Specify the DNS name that is associated with the load balancer. Get the DNS name by using the AWS Management Console,
        ...
        ///
        /// 				         AWS Global Accelerator accelerator  Specify the DNS name for your accelerator:
        /// 					             Global Accelerator API: To get the DNS name, use
        /// 							DescribeAccelerator.    AWS CLI: To get the DNS name, use
        ...
        /// 					when the alias target is an S3 bucket.  Other records in the same hosted zone  If the AWS resource that you specify in DNSName is a record or a group of records
        ...
        /// 		        Amazon API Gateway custom regional APIs and edge-optimized APIs  Specify the hosted zone ID for your API. You can get the applicable value using the AWS CLI command
        /// 					get-domain-names:
        ...
        /// 									to get the value of CanonicalHostedZoneId.
        ///
        /// 				         AWS Global Accelerator accelerator  Specify Z2BJ6XQ5FK7U4H.  An Amazon S3 bucket configured as a static website
