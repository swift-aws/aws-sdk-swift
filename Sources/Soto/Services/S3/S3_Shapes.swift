...
extension S3 {
    ...
    public enum AnalyticsFilter: AWSEncodableShape & AWSDecodableShape {
    ...
    public enum LifecycleRuleFilter: AWSEncodableShape & AWSDecodableShape {
        public static let _xmlNamespace: String? = "http://s3.amazonaws.com/doc/2006-03-01/"
    ...
    public enum MetricsFilter: AWSEncodableShape & AWSDecodableShape {
        public static let _xmlNamespace: String? = "http://s3.amazonaws.com/doc/2006-03-01/"
    ...
    public enum ReplicationRuleFilter: AWSEncodableShape & AWSDecodableShape {
        public static let _xmlNamespace: String? = "http://s3.amazonaws.com/doc/2006-03-01/"
    ...
    public enum SelectObjectContentEventStream: AWSDecodableShape {
        public static let _xmlNamespace: String? = "http://s3.amazonaws.com/doc/2006-03-01/"
    ...
    public struct ListMultipartUploadsOutput: AWSDecodableShape {
        ...
        /// Encoding type used by Amazon S3 to encode object keys in the response. If you specify encoding-type request parameter, Amazon S3 includes this element in the response, and returns encoded key name values in the following response elements:
    ...
    public struct ListPartsRequest: AWSEncodableShape {
        ...
        public init(bucket: String, expectedBucketOwner: String? = nil, key: String, maxParts: Int? = nil, partNumberMarker: String? = nil, requestPayer: RequestPayer? = nil, uploadId: String) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.key = key
            self.maxParts = maxParts
