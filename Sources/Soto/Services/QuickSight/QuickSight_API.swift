...
public struct QuickSight: AWSService {
    ...
    /// Creates a template from an existing QuickSight analysis or template. You can use the resulting
    ...
    /// 					resources.   QuickSight doesn't currently support the Tag Editor for AWS Resource Groups.
