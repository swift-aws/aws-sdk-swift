...
extension QuickSight {
    ...
    public enum DataSourceParameters: AWSEncodableShape & AWSDecodableShape {
    ...
    public enum PhysicalTable: AWSEncodableShape & AWSDecodableShape {
    ...
    public enum TransformOperation: AWSEncodableShape & AWSDecodableShape {
    ...
    public struct CreateDataSetRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.physicalTableMap, name: "physicalTableMap", parent: name, min: 1)
    ...
    public struct CreateIAMPolicyAssignmentRequest: AWSEncodableShape {
        ...
        /// The ID of the AWS account where you want to assign an IAM policy to QuickSight users or
        /// 			groups.
        public let awsAccountId: String
    ...
    public struct RegisterUserRequest: AWSEncodableShape {
        ...
        /// 			information on assuming IAM roles, see  assume-role in the AWS CLI Reference.
    ...
    public struct UpdateDataSetRequest: AWSEncodableShape {
        ...
        /// A set of one or more definitions of a  ColumnLevelPermissionRule .
        public let columnLevelPermissionRules: [ColumnLevelPermissionRule]?
        /// The ID for the dataset that you want to update. This ID is unique per AWS Region for each
        /// 			AWS account.
        public let dataSetId: String
        /// The folder that contains fields and nested subfolders for your dataset.
        public let fieldFolders: [String: FieldFolder]?
